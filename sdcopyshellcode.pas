...
begin
 ...
 Self.Caption:='Simple data copier shell 0.9';
...
var messages:array[0..18] of string=('The operation was successfully completed','The source file name is empty','The tarrget file name is empty','Cannot open the input file!','Cannot correctly close the target file!','Cannot correctly close the source file!','Cannot create or open the output file!','Cannot jump to the start offset!','Cannot get the current offset!','Cannot get the file size!','Cannot read data!','Cannot write data!','The number of written bytes is invalid: 0','The unexpected end of data','The start offset is invalid!','The block length is invalid!','The block length is too large!','Cannot decode an argument','Cannot allocate memory!');
var id:Integer;
